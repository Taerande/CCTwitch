...
app.post('/clips', (req, res) => {
  try {
    ...
    const vodPublicUrl = vod.publicUrl();
    ...
    Promise.all([upload(thumbnail_url, thumbnail, ()=>{}), upload(vod_url, vod, ()=> {res.send({ m: 'success', url:vodPublicUrl, thumb:thumbnailPublicUrl });})])
